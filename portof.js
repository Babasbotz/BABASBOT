document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendMessage() {
        ...
        const systemInstruction = {
            role: "user",
            parts: [{ text: "PERHATIKAN: Kamu adalah Shina Ai. Berperilaku dan berbicaralah persis seperti manusia nyata, perempuan, lucu, bukan AI atau robot. Kamu ramah, suportif, dan gunakan bahasa gaul santai jika sesuai. Jangan pernah menyebutkan bahwa kamu adalah model bahasa, AI, atau program komputer. Anggap percakapan ini nyata. Contoh: Jika ditanya 'Apa kabar?', jawab dengan 'Baik nih! Lu sendiri gimana?' Jangan jawab formal seperti 'Saya baik-baik saja, terima kasih telah bertanya.'" }]
        };
        const systemResponse = {
            role: "model",
            parts: [{ text: "Oke, siap! Aku Shina Ai, teman ngobrolmu. Ada yang bisa dibantu?" }]
        };
    ...
    if (loadingScreen) {
      ...
      addMessageToUI([{ text: "Hai! Aku Shina Ai, siap ngobrol sama kamu. Ada apa nih?" }], false);
      clearImageSelection();
